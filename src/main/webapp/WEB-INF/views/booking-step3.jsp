...
<div class="top-header py-2">
	...
	<nav class="navbar navbar-expand-lg bg-white w-100 p-0" id="navbar">
		<div class="container">
		  <a class="navbar-brand" href="hotel/index"><img src="/hotel/resources/images/logo.png" alt="Eden" class="img-fluid"></a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
          <h1 class="text-white py-100">Payment</h1>
      </div>
    </div>
  </div>
                ...
                <div class="ed-reservation">
                  ...
                  <div class="ed-total">
                    ...
                    <div class="ed-total-price">
                      ...
                      <span class="total-price">$ 749.99</span>
                    </div>
                  </div>

                  <div class="ed-pay-card">
                    <ul class="list-inline">
                      <li class="list-inline-item"><img src="/hotel/resources/images/booking/card1.jpg" alt="image" class="img-fluid"></li>
                      <li class="list-inline-item"><img src="/hotel/resources/images/booking/card2.jpg" alt="image" class="img-fluid"></li>
                      <li class="list-inline-item"><img src="/hotel/resources/images/booking/card3.jpg" alt="image" class="img-fluid"></li>
                      <li class="list-inline-item"><img src="/hotel/resources/images/booking/card4.jpg" alt="image" class="img-fluid"></li>
                      <li class="list-inline-item"><img src="/hotel/resources/images/booking/card5.jpg" alt="image" class="img-fluid"></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="comment-form py-4">
                  ...
                  <form class="form-top">
                      <div class="form-group row">
                        <label for="inputname" class="col-sm-4 col-form-label">Name Of The Card:</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group row">
                        <label for="inputcard" class="col-sm-4 col-form-label">Card Number:</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row ed-security">
                        ...
                        <div class="col-sm-8">
                          <img src="/hotel/resources/images/booking/card6.png" alt="image" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="form-bottom mt-5 border-top pt-4">
                        ...
                        <div class="float-lg-right mt-4 mt-lg-0">
                          <a href="confirmation.html" class="btn btn-main confirm-btn ">Confirm</a>
                        </div>
                    </div>
                  </form>
                </div>
