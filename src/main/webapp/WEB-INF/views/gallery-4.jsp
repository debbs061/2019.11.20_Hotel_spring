...
<section class="section"  id="gallery-page">
	<div class="container">
        ...
        <div class="row">
        	<div class="col-lg-3 mb-4 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-1.jpg" title="Photo 1">
						<img src="images/gallery/1-1.jpg" alt="" class="img-fluid">
					</a>

					<h4 class="mt-3 mb-1">Couple Suit</h4>
					<p> 2 double Bed</p>
				</div>
        	</div>
        	<div class="col-lg-3 mb-4 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-2.jpg" title="Photo 1">
						<img src="images/gallery/1-2.jpg" alt="" class="img-fluid">
					</a>

					<h4 class="mt-3 mb-1">Luxury Couple Suit</h4>
					<p> 2 double Bed</p>
				</div>
        	</div>
        	<div class="col-lg-3 mb-4 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-3.jpg" title="Photo 1">
						<img src="/hotel/resources/images/gallery/1-3.jpg" alt="" class="img-fluid">
					</a>

					<h4 class="mt-3 mb-1">Business Suit</h4>
					<p> 3 double Bed</p>
				</div>
        	</div>
			...
			<div class="col-lg-3 mb-4 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-4.jpg" title="Photo 1">
						<img src="/hotel/resources/images/gallery/1-4.jpg" alt="" class="img-fluid">
					</a>

					<h4 class="mt-4 mb-1">Family Suit</h4>
					<p> 2 double Bed</p>
				</div>
        	</div>
        	<div class="col-lg-3 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-5.jpg" title="Photo 1">
						<img src="/hotel/resources/images/gallery/1-5.jpg" alt="" class="img-fluid">
					</a>

					<h4 class="mt-3 mb-1">Delux Room</h4>
					<p> 2 double Bed</p>
				</div>
        	</div>
        	<div class="col-lg-3 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-6.jpg" title="Photo 1">
						<img src="/hotel/resources/images/gallery/1-6.jpg" alt="" class="img-fluid">
					</a>
        	...
        	<div class="col-lg-3 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-7.jpg" title="Photo 1">
						<img src="/hotel/resources/images/gallery/1-7.jpg" alt="" class="img-fluid">
					</a>
        	...
        	<div class="col-lg-3 col-md-6 col-sm-6">
        		<div class="gallery-item gallery-4-col">
					 <a href="/hotel/resources/images/gallery/1-8.jpg" title="Photo 1">
						<img src="/hotel/resources/images/gallery/1-8.jpg" alt="" class="img-fluid">
					</a>
