...
public class MyUtil extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		 ...
		 response.setContentType("application/octet-stream");
			 ...
			 response.addHeader("Content-Disposition", "attachment:filename=\"Giftcard_KOR.pdf\"" );
		 
			 String file = request.getSession().getServletContext().getRealPath("resources/file/Giftcard_KOR.pdf");
