...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>ITWill | Hotel Login</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 col-sm-12" style="text-align: center;">
                ...
                <form action=""  name="loginForm" method="post">
                    ...
                    <button class="btn btn-main" type="button" onclick="location.href='signup.action';">회원가입</button>
                    <button class="btn btn-main" type="button" onclick="sendIt();">로그인</button>
                    <button class="btn btn-main" type="button" onclick="location.href='searchPwd.action';">비밀번호 찾기</button>
                </form>
            </div>
