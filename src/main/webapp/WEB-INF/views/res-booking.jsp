  ...
  function sendIt() {
	...
	f = document.resBookingForm;
	  ...
	  str = f.resName.value;
		...
		f.action = "<%=cp %>/res-confirm.action";
		f.submit();
}
...
<div class="page-wrapper event-page">
	...
	<div class="single-event">
		...
		<form method="post" action="" id="resBookingForm">
			<a><h2>${res.resName }&nbsp;온라인예약</h2></a>
			<br/><br/>
								...
								<div class="form-row">
								    <div class="form-group col-md-3 col-sm-4">
								    	<div class="input-group tp-datepicker date" data-provide="datepicker">
										    <input type="text" class="form-control" placeholder="체크인" name="checkin" value="${res.checkin }" autocomplete="off">
									  ...
									  <c:if test="${!empty res.time }">
								 		<select id="time" class="form-control custom-select" name="time" >
									        <option selected>${res.time } 시</option>
										        <option value="10">10시</option>
								                <option value="11">11시</option>
								                <option value="12">12시</option>
								                <option value="13">13시</option>
									...
									<c:if test="${!empty res.adult }">
							    		<select id="adult" class="form-control custom-select" name="adult">
									        <option selected>${res.adult }명</option>
										        <option value="1">1명</option>
								                <option value="2">2명</option>
								                <option value="3">3명</option>
								                <option value="4">4명</option>
								    ...
								    <c:if test="${empty res.children }">
									 ...
									 <c:if test="${!empty res.children }">
							    		<select id="children" class="form-control custom-select" name="children">
									        <option selected>${res.children }명</option>
										        <option value="1">1명</option>
								                <option value="2">2명</option>
								                <option value="3">3명</option>
								                <option value="4">4명</option>
