...
<section id="about" class="section">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="section-title">
                    <p class="section-subtitle">KOREAN BBQ RESTAURANT, MYONGWOLGWAN</p>
                    <h2 class="mb-3">명월관</h2>
                    <p class="mb-4">숯불갈비 전문점 명월관은 최상급 한우와 전통 고급 참숯만을 사용하여 차별화된 갈비 맛을 선보입니다.단청 무늬 한옥의 단아한 멋이 돋보이는 인테리어와 한강이 내려다 보이는 아름다운 야외 정원을 갖추고 있어 특별한 날을 위한 장소로도 손색이 없습니다.</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="mb-5 mb-lg-0">
                    ...
                    <p>268석(전체 금연석)<br/>별실: 아람, 가람 12인 / 청자 24인<br/>별당: 무아, 비치 8인 / 예달 12인</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="mb-5 mb-lg-0">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="">
                    ...
                    <p>10%의 봉사료와 10%의 세금이 포함되어 있습니다.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <img src="/hotel/resources/images/restaurant/myeong-1.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6">
                <div class="about-content mt-4 mt-lg-0">
                    <h2 class="mb-3">한우 등심</h2>
					<p>최상의 우육을 선별하여 명월관 만의 노하우로 숙성시켰습니다.<br/>
					이 특별한 한우 등심이 명월관 전통 고급 참숯과 만나 은은한<br/>
					참숯의 향과 함께 입안 가득 깊은 풍미와 감칠맛을 느끼실 수 있습니다.</p>
        ...
        <div class="row align-items-center section pb-0">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="mb-3">U.S양념 갈비</h2>
               
				<P>미국 농무부 USDA 표준 기준 Choice 등급을 받은 갈비를 사용하여<br/>
				육즙이 좋고 연하며 풍미가 뛰어납니다. 여기에 각종 신선한 야채와<br/>
				천연 과즙으로 만든 명월관만의 특제 양념을 사용하여<br/>
				자극적이지 않으면서도 깊고 부드러운 맛을 선사합니다.</P>
