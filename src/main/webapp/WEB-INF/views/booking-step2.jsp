                    ...
                    <form action="mail/booking-form.php" id="bookingForm" method="post">
                      <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                          ...
                          <div class="form-group">
                            <input type="text" class="form-control" placeholder="Address 2" name="address-2" required>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="mt-4">
                              <a href="booking-step3.html" class="btn btn-main float-right" id="booking-submit-btn" >Submit </a>
                          </div>
                        </div>
                      </div>
                    </form>
